...
@Component({
	selector: 'app-pages-dialog-modal',
	templateUrl: './custom-pages-dialog.component.html',
  styleUrls: ['./custom-pages-dialog.component.scss']
})
export class ModalPagesDialogComponent implements OnInit {
  private subscriptions: Subscription[] = [];
	public errorMessage: string = '';
  public loading: boolean = false;
  public hasFormErrors: boolean = false;
  public dataType: string = 'page';
  public dataList: any[] = [];
    ...
    private layoutUtilsService: LayoutUtilsService,
		public dialogRef: MatDialogRef<ModalPagesDialogComponent>,
    ...
    if (!this.loading) {
      ...
      this.errorMessage = '';
			...
			let filterData = {orgId: this.requestService.orgId.getValue()}
			let filterObj = { perpage: this.pageSize, page: this.pageNumber, orderDir:this.orderDir, orderBy: this.orderBy, term:termConfiguration, termfields: ['title'], filter: filterData};
